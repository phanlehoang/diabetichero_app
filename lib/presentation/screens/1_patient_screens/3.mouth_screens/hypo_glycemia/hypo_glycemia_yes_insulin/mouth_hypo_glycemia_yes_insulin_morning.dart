...
import 'package:diabetichero_app/logic/1_patient_blocs/3.mouth_logic/hypo_glycemia_logic/hypo_glycemia_lantus_guide.dart';
...
class MouthHypoGlycemiaYesInsulinMorning extends StatelessWidget {
  final MouthProcedureOnlineCubit mouthProcedureOnlineCubit;

  const MouthHypoGlycemiaYesInsulinMorning({
    Key? key,
      ...
      children: [
        BlocBuilder(
            ...
            builder: (ct, st) {
              ...
              if (morningLogic.isWaitingForMeal) {
                DateTime eatingTime =
                    morningLogic.lastFastInsulinTime.add(Duration(minutes: 30));
              ...
              if (morningLogic.isSlowInsulinDone) {
              ...
              if (morningLogic.isGlucoseDone) {
                num slowInsulin =
                    (mouthProcedureOnlineCubit.profile.weight * 0.2).round();
                return Column(
                  children: [
                    Text('Tiêm $slowInsulin UI insulin Lantus.'),
